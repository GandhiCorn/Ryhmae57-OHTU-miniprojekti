...
scenario "Lisää uusi kirja referenssi varustettuna tagillä",{
	...
	fields.put(BibtexReferenceField.PUBLISHER, "Otava")
        fields.put(BibtexReferenceField.TAGS, "tägi")
    }
    when "Luo referenssi", {
    ...
    then "Tarkista että referenssi ollaan luotu", {
        ...
        app.getList().get(0).getField(BibtexReferenceField.TAGS).shouldBe "tägi"
